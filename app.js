...
//adding betting?
// jsbApp.money = document.getElementById("player-money").innerHTML = "Your money: $" + player.money;
// jsbApp.betting = document.getElementById('betting');
// jsbApp.bet = document.getElementById("bet").disabled = false;
// jsbApp.bet = document.getElementById("bet").max = player.money;
